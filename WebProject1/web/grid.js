...
function getFixedRows(config, rowsConfig) {
    ...
    return dom_1.el(".dhx_" + rowsConfig.name + "-wrapper", {
        ...
        style: __assign({}, styles, { left: rowsConfig.sticky ? left : 0, height: config[rowsConfig.name + "Height"], width: rowsConfig.sticky ? config.$totalWidth : rowsConfig.wrapper.width - BORDERS, zIndex: 9999 })
    }, [
...
function applyMathMethod(column, config, method) {
    var id = column.id;
    var columnData = config.data.reduce(function (items, item) {
...
exports.content = {
    inputFilter: {
        toHtml: function (column, config) { return dom_1.el("label.dhx_grid-filter__label.dxi.dxi-magnify", [
            dom_1.el("input", {
                type: "text",
        ...
        toHtml: function (column, config) {
            return dom_1.el("label.dhx_grid-filter__label.dxi.dxi-menu-down", [
                dom_1.el("select.dxi.dxi-menu-down", {
                    ...
                    onchange: [onInput, config.events, column.id, "selectFilter"],
                    _key: column.id
                }, [
...
var Grid = /** @class */ (function (_super) {
    ...
    Grid.prototype.adjustColumnWidth = function (id) {
        var index = core_1.findIndex(this.config.columns, function (k) { return k.id === id; });
...
function getContentHeight(renderConfig, isSticky, wrapper) {
    var contentHeight = wrapper.height - BORDERS;
